...
deploy {
    application {
        title = 'GriffonTimeSeries 0.1'
        vendor = System.properties['user.name']
        homepage = 'http://localhost/GriffonTimeSeries'
        description {
            complete = 'GriffonTimeSeries 0.1'
            oneline  = 'GriffonTimeSeries 0.1'
            minimal  = 'GriffonTimeSeries 0.1'
            tooltip  = 'GriffonTimeSeries 0.1'
        }
        icon {
            fallback {
...
app.fileType = '.groovy'
app.defaultPackageName = 'griffontimeseries'
